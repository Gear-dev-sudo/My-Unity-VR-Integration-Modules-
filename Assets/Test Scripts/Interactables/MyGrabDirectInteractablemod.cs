...
namespace my_unity_integration
{
    ...
    public class MyGrabDirectInteractablemoded : XRBaseInteractable
    {
        //Attach TransForms
        ...
        public class MyGrabInteractablemodEditor : UnityEditor.XR.Interaction.Toolkit.XRBaseInteractableEditor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                MyGrabDirectInteractablemoded interactable = (MyGrabDirectInteractablemoded)target;
