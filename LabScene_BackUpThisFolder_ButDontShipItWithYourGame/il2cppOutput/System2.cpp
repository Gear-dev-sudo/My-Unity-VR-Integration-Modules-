...
// System.Void System.Diagnostics.AsyncStreamReader::WaitUtilEOF()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AsyncStreamReader_WaitUtilEOF_mE7D47D96B5E2E32468C971ECEDE96FBCD46DF2C2 (AsyncStreamReader_tAC4F4C9FDA0C1A8D21F2B1C838C08C0E83AE871B* __this, const RuntimeMethod* method) 
{
	{
		ManualResetEvent_t63959486AA41A113A4353D0BF4A68E77EBA0A158* L_0 = __this->___eofEvent_6;
		if (!L_0)
		{
			goto IL_0026;
		}
	...
	{
		ManualResetEvent_t63959486AA41A113A4353D0BF4A68E77EBA0A158* L_1 = __this->___eofEvent_6;
		NullCheck(L_1);
		bool L_2;
		L_2 = VirtualFuncInvoker0< bool >::Invoke(9 /* System.Boolean System.Threading.WaitHandle::WaitOne() */, L_1);
		ManualResetEvent_t63959486AA41A113A4353D0BF4A68E77EBA0A158* L_3 = __this->___eofEvent_6;
		NullCheck(L_3);
